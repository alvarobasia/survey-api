...
describe('SingUp Controller', () => {
  test('Should return 400 if no name passed', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
  ...
  test('Should return 400 if no email passed', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'random',
  ...
  test('Should return 400 if no password passed', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'random',
  ...
  test('Should return 400 if invalid email is passed', async () => {
  ...
  test('Should return 200 if valid data is passed', async () => {
    ...
    const httpRequest = {
      body: {
        name: 'valid_name',
        email: 'valid_email@is_valid.com',
        password: 'valid_password',
